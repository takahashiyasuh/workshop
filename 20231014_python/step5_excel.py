...
# グラフ作成の元ネタを指定
labels = openpyxl.chart.Reference(ws, min_col=cmin, min_row=rmin+1, max_col=cmin, max_row=rmax)
data = openpyxl.chart.Reference(ws, min_col=cmax, min_row=rmin, max_col=cmax, max_row=rmax)
